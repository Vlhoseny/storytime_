...
(9, 'ahmed', 'masdjkahdkjahdkjahjs', 31, '', 'Manga', 'novel');
...
(2, 'Mohamed', '1', 'alhosenyabdulrahim99@gmail.com', '0100000000010'),
(3, 'yousef', '111', 'you@gmail.com', '01000000000');
...
CREATE TABLE `orders` (
  ...
  `Order_Card_Number` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `orders` (`Customer_Mail`, `Book_id`, `Customer_Full_Name`, `Order_Card_Number`) VALUES
('alhosenyabdulrahim99@gmail.com', 8, 'mohamed', '46465465465465446'),
('alhosenyabdulrahim99@gmail.com', 9, 'ahmed ', '465465465465456');
